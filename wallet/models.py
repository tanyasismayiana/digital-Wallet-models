...
class Wallet(models.Model):
    ...
    card = models.ForeignKey(
        Card, on_delete=models.CASCADE, related_name='Wallet_card')
...
class Account(models.Model):
    ...
    wallet = models.ForeignKey(
        Wallet, on_delete=models.CASCADE, related_name='Account_wallet')
    destination = models.CharField(max_length=30, null=True)
    card = models.OneToOneField(
        Card, on_delete=models.CASCADE, related_name='Account_card')
...
class Transaction(models.Model):
    ...
    third_Party = models.ForeignKey(
        Third_party, on_delete=models.CASCADE, related_name='Transaction_third_party')
